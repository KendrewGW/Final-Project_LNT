...
@section('body')
    ...
    <div class="m-5">
        ...
        <form action="/show-barang" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control" id="FotoBarang" placeholder="Foto Barang" name="Foto" value="{{ old('Foto') }}">
            </div>
